        ...
        implements ColumnHandle
{
    ...
    public static final int DATA_CHANGE_TYPE_ID = Integer.MIN_VALUE + 4;
    public static final String DATA_CHANGE_VERSION_NAME = "_change_version_id";
    public static final int DATA_CHANGE_VERSION_ID = Integer.MIN_VALUE + 5;
    public static final String DATA_CHANGE_TIMESTAMP_NAME = "_change_timestamp";
    public static final int DATA_CHANGE_TIMESTAMP_ID = Integer.MIN_VALUE + 6;
    public static final String DATA_CHANGE_ORDINAL_NAME = "_change_ordinal";
    public static final int DATA_CHANGE_ORDINAL_ID = Integer.MIN_VALUE + 7;
