        ...
        implements ConnectorMetadata
{
    ...
    private static boolean isBigLakeTable(TableDefinition tableDefinition)
    {
        if (tableDefinition instanceof ExternalTableDefinition externalTableDefinition) {
            //BigLake tables are external with connection and don't have objectMetadata
            return !isNullOrEmpty(externalTableDefinition.getConnectionId()) && isNullOrEmpty(externalTableDefinition.getObjectMetadata());
        }
        return false;
    }
